                            ...
                            @foreach($relatedPosts as $relatedPost)
                                <div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
                                    ...
                                    <a href="{{route('post.show', $relatedPost->id)}}"
                                       class="blog-post-permalink text-decoration-none"><h5
                    ...
                    <section class="comment-list mb-4">
                        ...
                        @foreach($post->comments as $comment)
                            <div class="comment-text mb-2">
                                <span class="username"><div>{{$comment->user->name}}</div><span class="text-muted float-right">{{$comment->dateAsCarbon->diffForHumans()}}</span></span>
                                {{$comment->message}}
                            </div>
                        @endforeach
                    </section>
                            ...
                            <div class="row">
                                <div class="form-group col-12" data-aos="fade-up">
                                    ...
                                    <textarea name="message" id="comment" class="form-control"
                                              placeholder="Оставьте свой комментарий" rows="10"></textarea>
                                </div>
                            </div>
                            <div class="row">
