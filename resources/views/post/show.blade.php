...
@section('content')
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">• {{$date->translatedFormat('F')}} {{$date->day}}, {{$date->year}} •
                    ...
                    <section class="related-posts">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
                                ...
                                <a href="{{route('post.show', $post->id)}}" class="blog-post-permalink text-decoration-none"><h5 class="post-title">{{$post->title}}</h5></a>
                            </div>
                            @endforeach
                        </div>
                    </section>
